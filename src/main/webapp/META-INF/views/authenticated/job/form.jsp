...
<acme:form>
	...
	<c:forEach items="$requestScope{descriptor.duties}" var="duty" varStatus="varStatus">
		<acme:form-panel code="authenticated.job.form.label.descriptor.duty">
			<acme:form-textbox code="authenticated.job.form.label.descriptor.duty.title" path="descriptor.duties[${varStatus.index}].title" />
			<acme:form-textarea code="authenticated.job.form.label.descriptor.duty.description"
				path="descriptor.duties[${varStatus.index}].description" />
			<acme:form-double code="authenticated.job.form.label.descriptor.duty.weekPercentage"
